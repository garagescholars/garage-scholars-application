...
async function main() {
  ...
  console.log("\n🎨 Removing trim from Coventry & Stonington — Kontext Pro\n");

  const prompt = "Remove all white trim and baseboards from the walls. Make the walls one continuous smooth painted surface all the way down to the floor and up to the ceiling with no trim lines. Change absolutely nothing else in the image.";
